...
#define USE_LV_FONT_DEJAVU_40 2
#define USE_LV_FONT_DEJAVU_40_LATIN_SUP 2
#define USE_LV_FONT_DEJAVU_40_CYRILLIC 2
#define USE_LV_FONT_SYMBOL_40 2

/* PROS adds the mono variant of DejaVu sans */
#define USE_PROS_FONT_DEJAVU_MONO_10 2
#define USE_PROS_FONT_DEJAVU_MONO_10_LATIN_SUP 2

#define USE_PROS_FONT_DEJAVU_MONO_20 2
#define USE_PROS_FONT_DEJAVU_MONO_LATIN_SUP_20 2 // this one doesn't work for some reason

#define USE_PROS_FONT_DEJAVU_MONO_30 2
#define USE_PROS_FONT_DEJAVU_MONO_30_LATIN_SUP 2

#define USE_PROS_FONT_DEJAVU_MONO_40 2
#define USE_PROS_FONT_DEJAVU_MONO_40_LATIN_SUP 2
